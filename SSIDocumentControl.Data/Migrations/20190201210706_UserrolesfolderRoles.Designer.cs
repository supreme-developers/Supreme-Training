...
namespace SSIDocumentControl.Data.Migrations
{
    ...
    [Migration("20190201210706_UserrolesfolderRoles")]
    partial class UserrolesfolderRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSIDocumentControl.Core.DocumentAuthorization.FolderRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("SSIDocumentControl.Core.DocumentAuthorization.UserRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("SSIDocumentControl.Core.DocumentAuthorization.UserRoles", b =>
                {
                    ...
                    b.HasOne("SSIDocumentControl.Core.RentUser", "User")
                        .WithMany()
