...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style lang="css">
      tr.selected {background-color:#FCF8E3}
      .FAtext{
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="panel panel-primary filterable ">
                        ...
                        <div id="assessors" class="panel-body pre-scrollable">
                            <div class="list-group " style="width: 100%">
                            <div ng-repeat="assessor in assessors" class="list-group-item ">
                ...
                <div class="col-lg-9">
                    <div class="row" ng-show="loading">
                     ...
                     <div class="col-lg-3 w3-animate-zoom" ng-show="employeeSelected && !loading">
                     ...
                     <div class="col-lg-3 w3-animate-zoom" ng-show="employeeSelected && !loading">
                            <div class="panel panel-info filterable">
                                ...
                                <div id="JobTitles" class="panel-body text-center  pre-scrollable">
                                    <table id="tbljobtitles" class="table table-condensed table-bordered">
                                        <tbody class="rep-drag connectedSortable">
                                            <tr ng-repeat="title in jobtitles">
                                                <td class="col-lg-10" align="left">
                     ...
                     <div class="col-lg-3 w3-animate-zoom" ng-show="employeeSelected && !loading"> <%--Job Resp--%>
                            <div class="panel panel-info filterable">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                ...
                                <div id="JobResp" class="panel-body text-center  pre-scrollable">  
                                     <table id="tbljobresps" class="table table-condensed table-bordered">
                                        <tbody class="rep-drag connectedSortable">
                                            <tr ng-repeat="resp in jobresps">
                                                <td class="col-lg-10" align="left">
                                                    <div class="checkbox checkbox-info">
