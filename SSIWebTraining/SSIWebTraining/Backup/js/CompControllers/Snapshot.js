...
.controller('SnapshotCtrl', function ($scope, $http, ngDialog, AddToSnapshot, RemovefromSnapshot)
{
    ...
    $scope.AddToSnapshot = function (defheaderid) {
        swal({
            title: "Wait!", text: "Are you sure you want add this Competency to " + $scope.ssEmployeeName + "'s Snapshot?", type: "warning", showCancelButton: true, confirmButtonColor: "#008D4C",
