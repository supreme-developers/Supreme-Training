    ...
    <div ng-app="SnapshotApp">
        <div ng-controller="SnapshotCtrl">
                            ...
                            <table id="AllComps" class="table table-striped table-bordered table-responsive table-condensed table-inverse"> 
                                ...
                                <tbody>
                                    <tr  ng-repeat="comp in Competencies | filter:search | offset: (CompcurrentPage - 1) * CompnumPerPage | limitTo:CompnumPerPage track by $index" >
                                        ...
                                        <td class="text-center"> {{comp.TrainingType}}</td>
                ...
                <div class="col-lg-3">
                    <div class="panel panel-primary filterable ">
                        <div class="panel-heading">
                            <h4 class="panel-title fa-2x">
                                <a id="assessorsheader" data-parent="#objects" class="clickable" href="#assessors" data-toggle="collapse">Select an Employee
                                </a>
                            </h4>
                        </div>
                        <div class="panel-body">
                             <input id="searchbox_employees" type="text" placeholder="Search..." 
                                        ng-model="searchEmployees" class="form-control input-lg" /> 

                        </div>
                        <div id="ssEmployees" class="panel-footer pre-scrollable minHeight w3-padding-0">
                            <div class="list-group " style="width: 100%">
                                <div ng-repeat="ssEmployee in ssEmployees | filter:searchEmployees" class="list-group-item ">
                ...
                <div class="col-lg-8">
                   <div class="panel panel-info filterable w3-animate-zoom" ng-show="ssEmployeeEmployeeID > 0">
                        ...
                        <div id="Competencies" class="panel-body minHeight">
                       
                             <input id="searchboxcomps" type="text" placeholder="Search Competencies..." 
                                        ng-model="searchComps" class="form-control input-lg hidden" /> 
                            <br />
                            ...
                            <table class="table table-condensed table-bordered table-hover">
                                ...
                                <tbody ng-model="employeeComps" >
                                    <tr ng-repeat="employeeComp in employeeComps | filter:searchComps | offset: (currentPage - 1) * numPerPage | limitTo:numPerPage" >
                                        <td class="col-lg-5">
